...
$mail->Username   = 'appointment@agrawaldentalclinics.in';       // SMTP username
$mail->Password   = "Rumit@2210";                           // SMTP password
$mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
$mail->Port       = 465;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

$form_name = $_REQUEST['name'];
$contact_email = $_REQUEST['email'];
$contact_phone = $_REQUEST['contact'];
$contact_services = $_REQUEST['services'];
$contact_date = $_REQUEST['date'];
$contact_time = $_REQUEST['time'];


//Recipients
$mail->setFrom('appointment@agrawaldentalclinics.in', 'Contact Us');
$mail->addAddress($contact_email, $form_name); 
$mail->addAddress('appointment@agrawaldentalclinics.in', 'Contact Us'); 

// $servername = "localhost";
// $username = "root";
// $password = "";
// $database = "u768511311_agrawaldental";

 $servername = "127.0.0.1:3306";
 $username = "u768511311_agrawaldental";
 $password = "Rumit@2210";
 $database = "u768511311_agrawaldental";
...
if (!$conn) {
 ...
 $sql = "INSERT INTO `appointement`(`name`, `email`, `contact`, `services`, `date`, `time`)VALUES
 ('$form_name', '$contact_email', '$contact_phone', '$contact_services', '$contact_date', '$contact_time');";
														 ...
														 <tr>
															<td align="center" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; word-break: break-word;">
															   <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
																  <tbody>
																	 <tr>
																		<td style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif;width: 160px;" width="160"> <a href="https://www.agrawaldentalclinics.in/" target="_blank" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; padding: 0 10px;"> <img alt="Agrawal Dental Clinic" height="auto" href="https://www.agrawaldentalclinics.in/" src="https://www.agrawaldentalclinics.in/assets/img/logoEmail.png" alt="Agrawal Dental Clinics" border="0" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="160"> </a> </td>
																	 </tr>
																  </tbody>
															   </table>
															</td>
																		...
																		<td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
																		   ...
																		   Dear <b>'.$form_name.'</b><br>
																			  ...
																			  <ul>
																				 ...
																				 <li><strong>Services</strong> - '.$contact_services.'</li>
																				 <li><strong>Appointment Date</strong> -'. $contact_date.'</li>
																				 <li><strong>Appointment Date</strong> -'. $contact_time.'</li>
																			  </ul>
																			  <br>
																		   </div>
																		</td>
															...
															<tr>
															   <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
																  <div style="font-family:OpenSans, Helvetica, Tahoma, Arial, sans-serif;font-size:12px;font-weight:400;line-height:20px;text-align:center;color:#4F4F4F;">
																	 <br /> &copy; 2023 Agrawal Dental Clinics. All rights reserved.
																	 <br />
																  </div>
															   </td>
															</tr>
...
?>
<script language="javascript">
window.open("https://www.agrawaldentalclinics.in/","_self");
</script>